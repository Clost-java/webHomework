...
<div class="header">
    <div class="container">
            ...
            <div class="title right">
                ...
                <ul>
                    <li class="left"><a href="">Premium</a></li>
                    <li class="left"><a href="">Support</a></li>
                    <li class="left"><a href="">DownLoad</a></li>
                    <li class="left"><span>|</span></li>
                    <li class="left"><a href="">Sign up</a></li>
                    <li class="left"><a href="">Log in</a></li>
                </ul>
