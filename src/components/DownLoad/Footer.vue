...
<div class="footer">
    <div class="container">
        ...
        <div class="bottom">
            ...
            <div>
                <ul>
                    <li class="left"><a href="">Legal</a></li>
                    <li class="left"><a href="">Privacy Centre</a></li>
                    <li class="left"><a href="">Privacy Policy</a></li>
                    <li class="left"><a href="">About Ads</a></li>
                    <li class="left"><a href="">About Ads</a></li>
                    <li class="left"><a href="">UK Tax Policy</a></li>
                    <li class="left"><a href="">UK Gender Pay Report</a></li>
                </ul>
                <p>© 2022 Spotify AB</p>
            </div>
        </div>
